      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-4 text-sm">
              Results-driven digital marketing professional transforming data into actionable insights for business growth.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground flex items-center gap-1">
            ...
            <a
              href="https://subash-portfolio-v01.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="ml-1 text-primary underline underline-offset-4 font-medium hover:text-primary/80 transition-colors"
            >
